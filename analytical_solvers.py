...
def get_analytical_ll_matrix(H_single, num_spins, num_neighbors):
    '''
    Computes an analytical Landau-Lifshitz coupled linearized matrix equation dS/dt = -(S cross Beff) for harmonix ansatz, where S is the magnetization at each lattice site as a column vector, ie S = (S1x,S1y,S1z,..,Snx,Sny,Snz). Considers all fluctuations (including longitudinal)
